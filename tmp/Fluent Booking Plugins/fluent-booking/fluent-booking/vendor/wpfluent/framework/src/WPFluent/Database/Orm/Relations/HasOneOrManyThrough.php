...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentBooking\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentBooking\Framework\Database\Orm\Model| \FluentBooking\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentBooking\Framework\Database\Orm\Model|\FluentBooking\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
